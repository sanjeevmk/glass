...
def find_reasonable_epsilon(eps,theta0, grad0, logp0, f):
    """ Heuristic for choosing an initial value of epsilon """
    epsilon = eps
    r0 = np.random.normal(0., 1.0, len(theta0))
...
def nuts6(epsilon,f, M, Madapt, theta0, delta):
    """
    ...
    epsilon = find_reasonable_epsilon(epsilon,theta0, grad, logp, f)
    print("found")
