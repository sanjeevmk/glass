...
void arap_forward_cuda(
    ...
    const at::Tensor updated_rotations)
{
    ...
    float* updated_rotations_data = updated_rotations.data<float>();

    ArapRotationKernelLauncher(batchsize, n, xyz_data, xyzP_data,neighborList_data,numNeighbors_data,accnumNeighbors_data,weightMatrix_data,blocklength_data,rotations_data,updated_rotations_data);
}
